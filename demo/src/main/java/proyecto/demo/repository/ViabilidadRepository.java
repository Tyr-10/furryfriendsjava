...
public interface ViabilidadRepository extends JpaRepository<Viabilidad, Long> {
    ...
    // Buscar viabilidades activas filtrando por nombre original (como búsqueda por
    // texto)
    ...
    // Buscar viabilidades por nombre de archivo (sin importar
    // mayúsculas/minúsculas), ordenadas por ID descendente
